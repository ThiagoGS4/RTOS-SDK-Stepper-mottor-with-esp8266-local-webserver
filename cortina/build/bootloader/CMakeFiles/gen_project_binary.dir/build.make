...
.bin_timestamp: bootloader.elf
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=C:\Users\Pichau\Documents\esp8266\cortina\build\bootloader\CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating binary image from built executable"
	C:\Users\Pichau\AppData\Local\Programs\Python\Python313\python.exe C:/esp/ESP8266_RTOS_SDK/components/esptool_py/esptool/esptool.py --chip esp8266 elf2image --flash_mode dio --flash_freq 40m --flash_size 2MB -o C:/Users/Pichau/Documents/esp8266/cortina/build/bootloader/bootloader.bin bootloader.elf
	"C:\Program Files\CMake\bin\cmake.exe" -E echo "Generated C:/Users/Pichau/Documents/esp8266/cortina/build/bootloader/bootloader.bin"
	"C:\Program Files\CMake\bin\cmake.exe" -E md5sum C:/Users/Pichau/Documents/esp8266/cortina/build/bootloader/bootloader.bin > C:/Users/Pichau/Documents/esp8266/cortina/build/bootloader/.bin_timestamp
